...
Sea a partir de aquí $n$ el número de características de los respectivos \textit{datasets}, $M$ el tamaño de la población, 
...
\begin{itemize}
 ...
 \begin{table}[H]	
  ...
  se aprecia con tasas tan elevadas de \textit{score}. Observamos eso sí, que la desviación típica del modelo estacionario es
  ...
  dos los cromosomas que se van sustituyendo a cada paso en la población de 30, tenemos menos diversidad, pero una convergencia
  ...
  superiores sobre el clasificador 3-NN. En tema de interpretabilidad, las soluciones son mejores que las proporcionadas por el
  clasificador 3-NN, pero peores que el SFS, ya que como se ha explicado la tasa de reducción tiende a ser 0.5.
