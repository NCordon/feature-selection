...
\scriptsize{\texttt{\input{BL}}}
\normalsize
\subsection{Enfriamiento Simulado}
\scriptsize{\texttt{\input{ES}}}
\normalsize\\
...
El esquema de enfriamiento consiste en calcular: 
