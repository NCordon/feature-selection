...
\begin{itemize}
 ...
 \item \href{NN3.r}: contiene una implementación del vecino más cercano con $k=3$
 \item \href{SFS.r}: implementación del algoritmo \textit{sequential forward selection}
 \end{itemize}
