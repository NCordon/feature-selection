...
\begin{itemize}
 ...
 \begin{table}[H]	
  ...
  reducción, y tanto la tasa de clasificación como de reducción son similares a las producidas por el SFS.
  ...
  ya que los atributos exceden a las instancias con las que entrenamos, y tenemos poca información para calcular cada 7
  una de las clases.
