...
\item Generación de solución inicial: en el caso del 3-NN, la solución inciial es la máscara trivial (todos los valores a 1).
...
\item Se considera una función mejor cuando aumenta la función objetivo (tasa de clasificación del 3-knn para la máscara
